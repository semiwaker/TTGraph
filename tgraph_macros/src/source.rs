...
use syn::{
  parse_quote, Fields, Generics, Ident, ItemStruct, PathArguments, Type, Visibility,
};
...
pub fn make_enum(
  result: &mut TokenStream, sources: &Vec<ConnectType>, name: &Ident, vis: &Visibility,
) -> Ident {
...
pub fn make_iter(
  result: &mut TokenStream, sources: &Vec<ConnectType>, name: &Ident, vis: &Visibility,
  generics: &Generics, source_enum: &Ident,
) {
